        ...
        <main class="main-cont">
            <div class="list-wrapper">
                <div class="list-wrapper-header">
                    ...
                    <a href=""><span class="add-product">Aggiungi prodotto</span></a>
                </div>
                    ...
                    <%
                        if (products != null && !products.isEmpty()) {
                            ...
                            for (ProductBean p : products) {
                                count++;
                    %>
                    <div class="list-row<%= count == products.size() ? " final" : "" %>">
                        <span><%= p.getName() %></span>
                        ...
                        <span>
                            <a href="view/<%= p.getId() %>" target="_blank"><span class="action-button">Visualizza</span></a>
                            <a href=""><span class="action-button">Modifica</span></a>
                        </span>
                    </div>
                    <% }
                    } else { %>
